  ...
  onTableAction = (event: string, data: anyObj) => {
    ...
    const actionFun = new Map([
      ...
      [
        'page-size-change',
        () => {
          this.table.filter!.pageSize = data.size
          this.getIndex()
        }
      ],
      [
      ...
      [
        'delete',
        () => {
          console.log([...[data.row[this.table.pk!]]], '-------')
      ...
      if (this.table.filter && this.table.filter.order != defaultOrder) {
        ...
        this.table.ref
          ...
          ?.sort(
            ...
            this.table.defaultOrder.order == 'desc' ? 'descending' : 'ascending'
          )
      }
    }
  }
