<template>
  <div class="layout-config-drawer">
    <el-drawer
      ...
      title="layouts.Layout configuration"
      size="310px"
      @close="onCloseDrawer"
    >
      <el-scrollbar class="layout-mode-style-scrollbar">
        <el-form ref="formRef" :model="configStore.layout">
          <div class="layout-mode-styles-box">
            <el-divider border-style="dashed">layouts.Layout mode</el-divider>
              ...
              <el-row class="layout-mode-box-style-row" :gutter="10">
                <el-col :span="12">
                  ...
                  >
                    ...
                    <div class="layout-mode-style-name">layouts.default</div>
                  </div>
                </el-col>
                <el-col :span="12">
                  <div
                  ...
                  >
                    ...
                    <div class="layout-mode-style-name">layouts.classic</div>
                  </div>
                </el-col>
              </el-row>
              <el-row :gutter="10">
                <el-col :span="12">
                  ...
                  >
                    ...
                    <div class="layout-mode-style-name">layouts.Single column</div>
                  </div>
                </el-col>
                <el-col :span="12">
                  <div
                  ...
                  >
                    ...
                    <div class="layout-mode-style-name">layouts.Double column</div>
                  </div>
                </el-col>
              </el-row>
            </div>
            <el-divider border-style="dashed">layouts.overall situation</el-divider>
            <div class="layout-config-global">
              <!-- <el-form-item size="large" label="layouts.Dark mode">
                <DarkSwitch @click="toggleDark()" />
              </el-form-item> -->
              <el-form-item label="layouts.Background page switching animation">
                <el-select
            ...
            <el-divider border-style="dashed">layouts.sidebar</el-divider>
            <div class="layout-config-aside">
              <el-form-item label="layouts.Side menu bar background color">
                <el-color-picker
            ...
            <el-divider border-style="dashed">layouts.Top bar</el-divider>
            <div class="layout-config-aside">
            ...
            >
              <template #reference>
                <div class="ba-center">
                  <el-button class="w80" type="info">layouts.Restore default</el-button>
                </div>
              </template>
            </el-popconfirm>
          </div>
